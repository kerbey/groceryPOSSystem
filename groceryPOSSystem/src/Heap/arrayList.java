...
//	private int maxSize;
//	public int place, lastIndex;
//	weightedGraph<String> weight = new weightedGraph<>();
//	//	private int maxxSize=maxSize+1;
//	public String []arrayOfCities= new String [lastIndex+1];//leaving maxsize without adding 1 creates error
//
//	public arrayList(int maxSize)
//	{
//		weight= new weightedGraph<>(maxSize);
